...
<head>
    ...
    <link rel="stylesheet" href="../../css/styles/main-styles.css">
    ...
    <header class="section1">
        <div class="container">
            <div class="text-box text-center">
                <h1>Uliana & Alisa</h1>
                <button class="btn btn-shop" onclick="window.location.href='catalog.html'">SHOP NOW</button>
            </div>
        </div>
    </header>
    ...
    <section class="section2">
        <div class="container">
            ...
            <div class="text-overlay">
                ...
                <button class="btn perfume-test-btn" onclick="window.location.href='test.blade.php'">Take the Test</button>
            </div>
        </div>
    </section>
